...
layui.define('jquery', function(exports){
  ...
  Class.prototype.arrow = function(){
    ...
    //模板
    var tplArrow = $([
      '<button type="button" class="layui-icon '+ ELEM_ARROW +'" lay-type="sub">'+ (options.anim === 'updown' ? '&#xe619;' : '&#xe603;') +'</button>'
      ,'<button type="button" class="layui-icon '+ ELEM_ARROW +'" lay-type="add">'+ (options.anim === 'updown' ? '&#xe61a;' : '&#xe602;') +'</button>'
    ].join(''));
