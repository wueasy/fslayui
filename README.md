...
* 免费使用：必须完全遵守 AGPLv3 的相关条款（开源源代码）,必须在以下地址[https://www.wueasy.com/open-source.html](https://www.wueasy.com/open-source.html)中录入开发商、使用商、访问地址、源码地址等信息,不得去掉底部的版权信息
